        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Text('First Name : ',style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,),),
                  Text("  "),
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  Icon(Icons.person),Text("  "),Text("  "),
                  Text('Last Name : ',style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,),),
                  Text("  "),
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  Icon(Icons.email),Text("  "),Text("  "),Text("  "),
                  Text('E-mail ID : ',style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,),),
                  Text("  "),
           ...
           /* Container(
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  Icon(Icons.calendar_month),Text("  "),Text("  "),
                  Text('Birth Date : ',style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,),),
                  Text("  "),
                  Text(birthDate,style: TextStyle(fontSize:20,fontWeight: FontWeight.bold),)
                ],
              ),
            ),
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  Icon(Icons.format_list_bulleted_rounded),Text("  "),Text("  "),
                  Text('Role : ',style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,),),
                  Text("  "),
